...
void explainVector()
{
    ...
    // {10, 20, 12, 23} this method takes iterator in the argument
    v.erase(v.begin() + 1);
    // {10, 20, 12, 23, 35}
...
void explainPQ()
{
    ...
    pq.pop();         // return 10 and queue will remain this -> {8, 5, 2}
	...
	//greater<int> is a comparetor operator which help
	//you to convert the priority of queue to accending order
